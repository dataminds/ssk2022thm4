...
- 구분 vs. 거울(Ryff et al., 2006)
  - 구분가설(distinct hypothesis): 안녕감과 불안녕감은 각각의 연속선상의 정도

  - 거울가설(mirror hypothesis): 안녕감과 불안녕감은 단일 연속선상의 양극단

- 참가자: 이주자 종단연구 참여 여성 135명(age = 61 ~ 91; M = 74, SD = 7.08) 대상 신경기능, 심리기능, 및 심리지표 측정
...
- 기능과 신호 중 무엇이 정신건강의 본질인지를 두고 논쟁이 있으나(예: Ryan & Deci, 2001), 이 연구에서는 기능을 신호를 예측하는 변수로 판단. 기능은 문제를 해결 또는 근본욕구를 충족하는 도구 혹은 자원이고, 신호는 기능 작동여부에 대한 평가 혹은 증상.

- 공동통화(common currency)로서의 쾌락 (Cabanac, 1992)
  - 공동통화는 범용적으로 사용되는 가치의 지표. 쾌락은 가치 자차게 아니라 가치에 대한 지표. 기능이 가치. 
...
- 임상
  ...
  - 예: 일반건강설문지(General Health Questionnaire-12: GHQ-12)다. 골드버그와 힐리어(Goldberg & Hillier, 1979)가 일반인의 정신질환 선별을 위해 자기보고식 설문지(평소 느끼던 심리상태에 비해 지난2~3주 동안의 변화 응답)로 개발한 척도다. 

  - GHQ에 대한 요인구조의 연구에서 요인들이 1~3개로 일관되지 않지만, 박종익 등(2012)의 한국성인을 대상으로 한 요인분석에서는 ‘우울 및 불안’(예: “불행하거나 우울하다고 느낀다” “자신감을 잃고 있다”)과 ‘사회적 역기능’(예: “어떤 일에 대해 결정할 수 있다고 느낀다” “일상생활을 정상적으로 즐길 수 있다”)등 2개 요인이 나타났다. 
  
  - 심리적안녕감 척도(자율성, 관계성, 통제성, 목적성, 개인성장, 자아수용)
  - 주관적안녕감 척도(삶의 만족, 긍정감정, 부정감정)
